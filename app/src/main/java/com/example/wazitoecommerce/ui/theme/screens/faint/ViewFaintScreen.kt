...
import com.example.wazitoecommerce.models.faint
...
@Composable
fun ViewFaintScreen(navController:NavHostController) {
    Column(modifier = Modifier
        ...
        //TopAppBar
        TopAppBar(title = { Text(text = "FAINT FIRST AID",
        ...
        val emptyInstructionState = remember { mutableStateOf(faint("","","","","")) }
        var emptyInstructionsListState = remember { mutableStateListOf<faint>() }
...
fun instructions(instruction:String,
                 ...
                 InstructionRepository:FaintViewModel,
) {
...
fun ViewFaintScreenPreview(){
    ...
    ViewFaintScreen(navController = rememberNavController())
}

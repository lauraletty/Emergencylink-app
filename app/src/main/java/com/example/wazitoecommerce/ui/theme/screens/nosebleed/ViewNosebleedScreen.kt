...
fun ViewNosebleedScreen(navController: NavHostController) {
    Column(modifier = Modifier
        ...
        //TopAppBar
        TopAppBar(title = { Text(text = "NOSEBLEED FIRST AID",
        ...
        val emptyInstructionState = remember { mutableStateOf(nosebleed("","","","","")) }
        var emptyInstructionsListState = remember { mutableStateListOf<nosebleed>() }
...
fun instructions(instruction:String,
                 ...
                 InstructionRepository: NosebleedViewModel,
) {

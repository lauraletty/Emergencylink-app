...
@Composable
fun AddBurnScreen(navController: NavHostController){
    Column(
        ...
        Text(
            text = "Burn first aid instruction",
            fontSize = 25.sp,
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Burn aid instruction *") },
...
fun AddBurnScreenPreview(){

    AddBurnScreen(navController = rememberNavController())
}